...
const p1 = [5264, 95, -3856];
const p2 = [5258, 96, -3862];
...
function createBot() {
    ...
    bot.once('spawn', async () => {
        ...
        setTimeout(() => {
            ...
            console.log("?? /is warp digzone ga teleport...");
        }, 10000);
        ...
        setTimeout(() => {
            ...
            bot.pathfinder.setGoal(new GoalNear(5263, 93, -3859, 1));  // Yangi maqsad
